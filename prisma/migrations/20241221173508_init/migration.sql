...
-- CreateIndex
CREATE UNIQUE INDEX "Folder_coverId_key" ON "Folder"("coverId");
...
-- AddForeignKey
ALTER TABLE "Folder" ADD CONSTRAINT "Folder_coverId_fkey" FOREIGN KEY ("coverId") REFERENCES "Image"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "AccessToken" ADD CONSTRAINT "AccessToken_folderId_fkey" FOREIGN KEY ("folderId") REFERENCES "Folder"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
