    ...
    images:
        typeof window === "undefined"
            ? z
                  ...
                  .refine(
                      file => {
                          return Array.from(file).every(
                              f => f instanceof File && (f.type.startsWith("image/") || f.type.startsWith("video/"))
                          );
                      },
                      {
                  ...
                  .refine(file => Array.from(file).every(f => f instanceof File && f.size < 1024 * 1024 * 1000), {
...
const userWithCounts = Prisma.validator<Prisma.UserDefaultArgs>()({
...
export type FolderWithFilesWithFolderAndCommentsAndCreatedBy = Prisma.FolderGetPayload<
    typeof folderWithFilesWithFolderAndCommentsAndCreatedBy
>;
