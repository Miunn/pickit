...
import { FolderWithAccessToken, FolderWithCover, FolderWithImagesCount, FolderWithVideosCount } from "@/lib/definitions";
...
export default function FoldersContent({ defaultView, folders }: { defaultView?: ViewState, folders: (FolderWithAccessToken & FolderWithImagesCount & FolderWithVideosCount & FolderWithCover)[] }) {
