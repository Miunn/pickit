...
export default function FolderDescription({
  className,
}: {
  className?: string;
}) {
  ...
  return (
    <>
      <div
        className={cn(
          "relative group overflow-auto w-full col-span-1 sm:col-span-1 lg:max-w-64 max-h-[200px] border border-primary rounded-lg p-4",
          className
        )}
      >
