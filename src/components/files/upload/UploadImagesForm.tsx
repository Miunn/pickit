...
export function UploadImagesForm({
          ...
          try {
            ...
            for (let i = 0; i < fileBuffer.byteLength; i += sampleSize) {
              const chunk = fileBuffer.slice(
                i,
                Math.min(i + sampleSize, fileBuffer.byteLength),
              );
            ...
            toast(
              <div className="w-full">
                ...
                <Progress
                  value={(uploadedCount / data.images.length) * 100}
  ...
  return (
    <Form {...uploadImageForm}>
      <form
        onSubmit={uploadImageForm.handleSubmit(onSubmit)}
        className="space-y-8"
      >
        <FormField
            ...
            <div className="flex items-center gap-2">
              <Switch
                ...
                onCheckedChange={(checked) =>
                  uploadImageForm.setValue("shouldNotify", checked)
                }
              />
