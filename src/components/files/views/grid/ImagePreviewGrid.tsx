      ...
      <ContextMenu key={file.id} modal={false}>
        <ContextMenuTrigger asChild>
          ...
          >
            ...
            >
              <div
                className={`${selected.includes(file.id) ? "scale-95" : ""}`}
              >
                <div
                  className={`relative h-32 sm:h-36 mb-4 flex justify-center items-center group`}
                >
                  {file.type === FileType.VIDEO ? (
                    <LoadingImage
                      ...
                      alt={file.name}
                      className={
                        "relative border border-primary rounded-xl object-cover"
                      }
                ...
                <div
                  className={"text-sm h-4 flex items-center justify-between"}
                >
                  <div className="h-full flex items-center">
                    <TooltipProvider>
                      <Tooltip>
                        <TooltipTrigger asChild>
                          <p
                            className={"text-sm opacity-60 capitalize truncate"}
                          >
