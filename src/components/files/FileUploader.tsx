                    ...
                    errors.forEach(({ code }) => {
                        if (code === "file-too-large") {
                            toast({
                                ...
                                description: t("errors.fileSize.description", {
                                    name: file.name,
                            ...
                            toast({
                                ...
                                description: t("errors.fileType.description", {
                                    name: file.name,
                                    allowedTypes: Object.keys(accept).join(", "),
                                }),
                                variant: "destructive",
                            });
                        }
            ...
            >
                {({ getRootProps, getInputProps, isDragActive }) => (
                    <div
                        {...getRootProps()}
                        className={cn(
                            "group relative grid min-h-52 w-full cursor-pointer place-items-center rounded-lg border-2 border-dashed border-muted-foreground/25 px-5 py-2 text-center transition hover:bg-muted/25",
                    ...
                    >
                        ...
                        {isDragActive ? (
                            <div className="flex flex-col items-center justify-center gap-4 sm:px-5">
                                ...
                                <p className="font-medium text-muted-foreground">{t("dragActiveTitle")}</p>
                            </div>
                        ) : (
                            <div className="flex flex-col items-center justify-center gap-4 sm:px-5">
                                <div className="rounded-full border border-dashed p-3">
...
function FilePreview({ file }: FilePreviewProps) {
    ...
    if (file.type.startsWith("video/")) {
        return <PlayCircle className="size-10 text-muted-foreground" aria-hidden="true" />;
    }
