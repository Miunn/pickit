...
export default function LandingHead() {
	...
	return (
		<>
			...
			<div
				ref={seeMoreRef}
				className="max-w-7xl grid grid-cols-4 xl:grid-cols-3 my-16 lg:my-32 mx-16"
			>
				<div className="col-start-1 lg:col-start-2 col-end-5 xl:col-end-4">
					...
					<p>
						With Echomori, you can store and share your photos to your loved ones
						easily. Our platform is secure and easy to use, you can create albums
