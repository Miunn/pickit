    ...
    return (
        <div className="flex flex-col xl:grid xl:grid-cols-2 gap-6 min-h-[444px]">
            <div className="flex flex-col gap-3">
                <Card
                    className={`group cursor-pointer transition-all duration-500 ease-in-out overflow-hidden ${expandedIndex === 0 ? "max-h-64" : "max-h-18"}`}
                    onClick={() => setExpandedIndex(0)}
                >
                    <CardHeader>
                        <CardTitle
                            className={`flex items-center gap-2 ${expandedIndex === 0 ? "text-primary" : "text-gray-500"}`}
                            onClick={() => setExpandedIndex(0)}
                        >
                            <kbd
                                className={
                    ...
                    <CardContent
                        className={`transition-all duration-500 ease-in-out ${expandedIndex === 0 ? "max-h-32 opacity-100" : "max-h-0 opacity-0 py-0"}`}
                    >
                        <p
                        ...
                        <div className="relative h-2 w-full overflow-hidden rounded-full bg-primary/20">
                            <div
                                ref={progressRefs.current[0]}
                                className="group-hover:[animation-play-state:paused] h-full w-0 flex-1 bg-primary animate-progress"
                                onAnimationEndCapture={() => setExpandedIndex((expandedIndex + 1) % 4)}
                            ></div>
                        </div>
                    </CardContent>
                </Card>
                <Card
                    className={`group cursor-pointer transition-all duration-500 ease-in-out overflow-hidden ${expandedIndex === 1 ? "max-h-64" : "max-h-18"}`}
                    onClick={() => setExpandedIndex(1)}
                >
                    <CardHeader>
                        <CardTitle
                            className={`flex items-center gap-2 ${expandedIndex === 1 ? "text-primary" : "text-gray-500"}`}
                        >
                            <kbd
                                className={
                                    expandedIndex === 1
                    ...
                    <CardContent
                        className={`transition-all duration-500 ease-in-out ${expandedIndex === 1 ? "max-h-32 opacity-100" : "max-h-0 opacity-0 py-0"}`}
                    >
                        <p className="text-sm text-foreground mb-4">{t("section2.description")}</p>
                        <div className="relative h-2 w-full overflow-hidden rounded-full bg-primary/20">
                            <div
                                ref={progressRefs.current[1]}
                ...
                <Card
                    className={`group cursor-pointer transition-all duration-500 ease-in-out overflow-hidden ${expandedIndex === 2 ? "max-h-64" : "max-h-18"}`}
                    onClick={() => setExpandedIndex(2)}
                >
                    <CardHeader>
                        <CardTitle
                            className={`flex items-center gap-2 ${expandedIndex === 2 ? "text-primary" : "text-gray-500"}`}
                        >
                            <kbd
                                className={
                                    expandedIndex === 2
                    ...
                    <CardContent
                        className={`transition-all duration-500 ease-in-out ${expandedIndex === 2 ? "max-h-32 opacity-100" : "max-h-0 opacity-0 py-0"}`}
                    >
                        <p className="text-sm text-foreground mb-4">{t("section3.description")}</p>
                        <div className="relative h-2 w-full overflow-hidden rounded-full bg-primary/20">
                            <div
                                ref={progressRefs.current[2]}
                                className="group-hover:[animation-play-state:paused] h-full w-0 flex-1 bg-primary"
                                onAnimationEndCapture={() => setExpandedIndex((expandedIndex + 1) % 4)}
                            ></div>
                        </div>
                ...
                <Card
                    className={`group cursor-pointer transition-all duration-500 ease-in-out overflow-hidden ${expandedIndex === 3 ? "max-h-64" : "max-h-18"}`}
                    onClick={() => setExpandedIndex(3)}
                >
                    <CardHeader>
                        <CardTitle
                            className={`flex items-center gap-2 ${expandedIndex === 3 ? "text-primary" : "text-gray-500"}`}
                        >
                            <kbd
                                className={
                                    expandedIndex === 3
                    ...
                    <CardContent
                        className={`transition-all duration-500 ease-in-out ${expandedIndex === 3 ? "max-h-32 opacity-100" : "max-h-0 opacity-0 py-0"}`}
                    >
                        <p className="text-sm text-foreground mb-4">{t("section4.description")}</p>
                        <div className="relative h-2 w-full overflow-hidden rounded-full bg-primary/20">
                            <div
                                ref={progressRefs.current[3]}
                                className="group-hover:[animation-play-state:paused] h-full w-0 flex-1 bg-primary"
                                onAnimationEndCapture={() => setExpandedIndex((expandedIndex + 1) % 4)}
                            ></div>
                        </div>
