			...
			<div className="flex flex-col gap-3">
				<Card
					className={cn(
						...
						expandedIndex === 0 ? "max-h-64" : "max-h-18"
					)}
					...
					<CardHeader>
						<CardTitle
							className={cn(
								...
								expandedIndex === 0 ? "text-primary" : "text-gray-500"
							)}
							onClick={() => setExpandedIndex(0)}
						>
							<kbd
						...
						<div className="relative h-2 w-full overflow-hidden rounded-full bg-primary/20">
							<div
								...
								onAnimationEndCapture={() =>
									setExpandedIndex((expandedIndex + 1) % 4)
								}
							></div>
						</div>
					</CardContent>
				...
				<Card
					className={cn(
						...
						expandedIndex === 1 ? "max-h-64" : "max-h-18"
					)}
				...
				>
					<CardHeader>
						<CardTitle
							className={cn(
								"flex items-center gap-2",
								expandedIndex === 1 ? "text-primary" : "text-gray-500"
							)}
						>
							<kbd
								className={cn(
				...
				<Card
					className={cn(
						"group cursor-pointer transition-all duration-500 ease-in-out overflow-hidden",
						expandedIndex === 2 ? "max-h-64" : "max-h-18"
					)}
				...
				>
					<CardHeader>
						<CardTitle
							className={cn(
								"flex items-center gap-2",
								expandedIndex === 2 ? "text-primary" : "text-gray-500"
							)}
						>
							<kbd
								className={cn(
				...
				<Card
					className={cn(
						"group cursor-pointer transition-all duration-500 ease-in-out overflow-hidden",
						expandedIndex === 3 ? "max-h-64" : "max-h-18"
					)}
				...
				>
					<CardHeader>
						<CardTitle
							className={cn(
								"flex items-center gap-2",
								expandedIndex === 3 ? "text-primary" : "text-gray-500"
							)}
						>
							<kbd
								className={cn(
