    ...
    return (
        <Dialog open={open} onOpenChange={(open) => {
            ...
            <DialogContent>
                ...
                <Input placeholder={t('confirmation.placeholder', { name: user.name })} onChange={(e) => setConfirmation(e.currentTarget.value)} />
                ...
                <DialogFooter>
                    ...
                    {loading
                        ...
                        : <Button variant={"destructive"} disabled={confirmation !== user.name} onClick={onDelete}>{t('actions.submit')}</Button>
                    }
                </DialogFooter>
            </DialogContent>
        </Dialog>
