                    ...
                    >
                        ...
                        <Row>
                            ...
                            >
                                ...
                                <Text>
                                    Cette adresse a été renseignée au sein d&apos;un compte{" "}
                                    <strong>{process.env.NEXT_PUBLIC_APP_NAME}</strong>.
                                </Text>

                                <Text>
                                    Pour vérifier et continuer à utiliser votre compte, veuillez cliquer sur le bouton
                                    ci-dessous.
                                </Text>

                                <div className="bg-[#f9f9f9] p-[10px] my-[15px] border-dashed border-[1px] border-[#cccccc]">
                                    <Button
                                        href={`${baseUrl}/en/account/verify-account/${token}`}
                                ...
                                <Text>
                                    Si vous n&apos;avez pas de compte Echomori ou que vous n&apos;avez pas effectué de
                                    changement, vous pouvez ignorer ce message.
                                </Text>
