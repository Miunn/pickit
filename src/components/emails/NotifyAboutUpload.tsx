				...
				<Tailwind>
					<Body className="m-0 p-0 max-w-[600px] mx-auto mt-[30px]">
						...
						>
							<Row>
								<Column
									className="text-center bg-[#f4f4f4] p-4"
									align="center"
								>
									<Section width="100%">
										<tr>
							...
							<Row>
								...
								>
									...
									<Text>
										...
										{count === 1
											? "1 nouveau fichier"
											: `${count} nouveaux fichiers`}{" "}
										à <strong>{folderName}</strong>
									</Text>

									<Text>
										Cliquez sur le bouton ci-dessous pour y
										accéder :
									</Text>
									...
									{isLocked ? (
										<Text>
											{name} a vérouillé ce dossier
											par un code que vous devrez
											renseigner avant de pouvoir
											accéder à son contenu. Si vous
											ne connaissez pas ce code,
											veuillez contacter {name} pour
											l&apos;obtenir.
										</Text>
									) : null}
							...
							>
								...
								<Text>
									...
									{count === 1
										? "1 new file"
										: `${count} new files`}{" "}
									added to <strong>{folderName}</strong>
								</Text>
								...
								{isLocked ? (
									<Text>
										{name} locked this folder with a code
										that you will need to enter before you
										can access its content. If you
										don&apos;t know this code, please
										contact {name} to get it.
									</Text>
								) : null}
