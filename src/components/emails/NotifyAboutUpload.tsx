...
export default function NotifyAboutUploadTemplate({ name, folderName, link, isLocked, count }: { name: string, folderName: string, link: string, isLocked: boolean, count: number }) {
    return (
        <Html>
            <Head>
                    ...
                    <Section style={{
                        ...
                        <Row>
                            <Column style={{
                                ...
                                <Text>{name} a ajouté {count} nouveaux fichiers à <strong>{folderName}</strong></Text>
