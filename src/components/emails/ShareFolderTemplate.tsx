...
export default function ShareFolderTemplate({
    name,
    folderName,
    link,
    isLocked,
                        ...
                        <Row>
                            ...
                            >
                                <Text className="text-center text-xl tracking-wide">
                                    Un dossier vous a été partagé !
                                </Text>

                                <Text>Bonjour,</Text>

                                <Text>
                                    <strong>{name}</strong> a partagé le dossier <strong>{folderName}</strong> avec vous
                                    sur {process.env.NEXT_PUBLIC_APP_NAME}
                                ...
                                <Text>
                                    Cliquez sur le bouton ci-dessous pour y accéder et découvrir les photos et vidéos
                                    qu&apos;il contient :
                                </Text>
                                ...
                                {isLocked ? (
                                    <Text>
                                        {name} a vérouillé ce dossier par un code que vous devrez renseigner avant de
                                        pouvoir accéder à son contenu. Si vous ne connaissez pas ce code, veuillez
                                        contacter {name} pour l&apos;obtenir.
                                    </Text>
                                ) : null}
