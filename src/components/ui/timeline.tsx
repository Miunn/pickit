...
export const Timeline = ({ data }: { readonly data: TimelineEntry[] }) => {
			...
			<div ref={ref} className="relative max-w-7xl mx-auto pb-20">
				...
				>
					<motion.div
						...
						className="absolute inset-x-0 top-0  w-[2px] bg-linear-to-t from-primary via-accent to-transparent from-0% via-10% rounded-full"
					/>
				</div>
			</div>
		</div>
