			...
			<CommandDialog open={open} onOpenChange={setOpen} modal={true}>
				...
				<CommandList>
					...
					<CommandGroup heading={t("sections.pages")}>
						...
						<CommandItem
							onSelect={() => runCommand(() => router.push("/app/folders"))}
						>
							<Folders />
							<span>{t("pages.folders")}</span>
						</CommandItem>
						<CommandItem
							onSelect={() => runCommand(() => router.push("/app/images"))}
						>
							<Images />
							<span>{t("pages.images")}</span>
						</CommandItem>
						<CommandItem
							onSelect={() => runCommand(() => router.push("/app/links"))}
						>
							<Link />
						...
						<CommandItem
							onSelect={() =>
								runCommand(() => router.push("/app/shared-with-me"))
							}
						>
							<Waypoints />
						...
						<CommandItem
							onSelect={() => runCommand(() => router.push("/app/account"))}
						>
							<UserPen />
					...
					<CommandGroup heading={t("sections.account")}>
						<CommandItem
							onSelect={() =>
								runCommand(() =>
									router.push("/app/account?focus=email")
								)
							}
						>
							<Mails />
						...
						<CommandItem
							onSelect={() =>
								runCommand(() =>
									router.push("/app/account?focus=password")
								)
							}
						>
							<RectangleEllipsis />
