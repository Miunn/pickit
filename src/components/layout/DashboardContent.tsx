...
export default function DashboardContent({ lastFolders, lastFiles }: { lastFolders: (FolderWithAccessToken & FolderWithFilesCount & FolderWithCover)[], lastFiles: (FileWithFolder & FileWithComments)[] }) {
