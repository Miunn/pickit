                ...
                <div onClick={onRead} className="flex items-center justify-between gap-2 hover:bg-muted rounded-lg p-4">
                    <div>
                        <p>
                            ...
                            <span className="font-bold text-foreground">{notification.folderName}</span> with you
                        </p>
                        <p className="text-sm text-muted-foreground">
                            {formatter.dateTime(notification.createdAt, { dateStyle: "medium", timeStyle: "short" })}
                        </p>
                    </div>
                ...
                <div onClick={onRead} className="flex items-center justify-between gap-2 hover:bg-muted rounded-lg p-4">
                    <div>
                        <p>
                            ...
                            files to <span className="font-bold text-foreground">{notification.folderName}</span>. Check
                            them out!
                        </p>
                        <p className="text-sm text-muted-foreground">
                            {formatter.dateTime(notification.createdAt, { dateStyle: "medium", timeStyle: "short" })}
