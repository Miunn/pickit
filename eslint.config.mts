			...
			"no-restricted-imports": [
				"error",
				{
					patterns: [
						...
						{
							ignores: ["src/data/slug-service.ts"],
							group: ["slugify", "slugify/*"],
							message: "Please use the SlugService from src/lib/services/slug-service.ts instead of importing slugify directly.",
						},
					],
				},
			],
